...
ModelPusherConfig, ModelTrainerConfig, TrainingPipelineConfig,  DataValidationConfig, ModelTrainerConfig, ModelPusherConfig, TrainingPipelineConfig
from storesales.util.util import read_yaml_file
...
class Configuration:
    ...
    def get_training_pipeline_config(self)-> TrainingPipelineConfig:
        try:
            ...
            logging.info(f"Training pipe line: {training_pipeline_config}")
